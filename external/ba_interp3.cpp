...
static
        InterpolationMethod parseInterpolationMethod(char* method_string) {
    if (method_string == NULL)
        return Linear;
    
    if (strcmp(method_string,"nearest") == 0) {
        return Nearest;
    }
    else if (strcmp(method_string,"linear") == 0) {
        return Linear;
    }
    else if (strcmp(method_string,"cubic") == 0) {
        return Cubic;
    }
    else {
